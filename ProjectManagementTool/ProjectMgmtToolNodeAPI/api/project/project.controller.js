...
module.exports={
    create:(req,res)=>{
        ...
        projectService.create(body).then(result=>{
            if(result){
                res.json({
                    response:{
                        success:1,
    ...
    getAll:(req,res)=>{       
        projectService.list().then(result=>{
            if(result){
                res.json({
                    success:1,
    ...
    getProjectById:(req,res)=>{      
        ...
        projectService.getProjectById(id).then(result=>{
            if(result){
                res.json({
                    response:{
                        success:1,
    ...
    deleteProject:(req,res)=>{      
        const id = req.params.id; 
        projectService.deleteProject(id).then(result=>{
            if(result){
                res.json({
                    response:{
                        success:1,
    ...
    updateProject:(req,res)=>{      
        ...
        const body = req.body 
        ValidateProjectBody(body,res);
        projectService.updateProject(id,body).then(result=>{
            if(result){
                res.json({
                    response:{
                        success:1,
